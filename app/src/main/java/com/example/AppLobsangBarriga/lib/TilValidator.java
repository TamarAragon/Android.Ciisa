...
public class TilValidator {
    ...
    public TilValidator date() {
        if (mustValidate()) {
            ...
            this.setError(invalidField, String.format("La fecha es invalida. Formato esperado: %s", DateUtils.DATE_PATTERN));
        }
        return this;
    }
    ...
    public TilValidator number() {
        if (mustValidate()) {
            ...
            this.setError(invalidField, "El valor debe ser un numero");
        }
        return this;
    }
